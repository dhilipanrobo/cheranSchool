...
public class activity_rankcardgii extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_rankcardgii );
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            //  getJSON1(" http://192.168.43.122/notesboard/getrank.php?term="+ter);
            getJSON1(" https://www.welleservices.com/noticeboard/csgetrankgii.php?term=" + ter+"&rno="+id);
