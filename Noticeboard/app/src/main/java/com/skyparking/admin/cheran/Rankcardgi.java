...
public class Rankcardgi  extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_rankcardgi );
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            science[i] = obj.getString("physics");
            social[i] = obj.getString("chemistry");
            bio[i] = obj.getString("biology");
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            //  getJSON1(" http://192.168.43.122/notesboard/getrank.php?term="+ter);
            getJSON1(" https://www.welleservices.com/noticeboard/csgetrankgi.php?term=" + ter+"&rno="+id);
