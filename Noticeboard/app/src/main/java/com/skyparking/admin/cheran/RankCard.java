...
public class  RankCard extends AppCompatActivity implements View.OnClickListener {
   ...
   String[] term = { "I-Term(FA)", "I-Term(SA)", "II-Term(FA)", "II-Term(SA)", "III-Term(FA)","III-Term(SA)"  };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv8=(TextView) findViewById(R.id.textView34);
        tv9=(TextView) findViewById(R.id.textView31);
        tv10=(TextView) findViewById(R.id.textView33);
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        String[] hindi = new String[jsonArray.length()];
        ...
        String[] gk = new String[jsonArray.length()];
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            hindi[i] = obj.getString("hindi");
            maths[i] = obj.getString("maths");
            science[i] = obj.getString("science");
            social[i] = obj.getString("social");
            cs[i] = obj.getString("cs");
            gk[i] = obj.getString("gk");
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            //  getJSON1(" http://192.168.43.122/notesboard/getrank.php?term="+ter);
            getJSON1(" https://www.welleservices.com/noticeboard/csgetrank.php?term=" + ter+"&rno="+id);
