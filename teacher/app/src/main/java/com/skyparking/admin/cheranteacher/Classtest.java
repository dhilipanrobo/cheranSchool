...
public class Classtest extends AppCompatActivity implements View.OnClickListener{
    Spinner spinner;
    String[] term = { "Tamil", "English","Maths","Science","SocialScience","Physics","Chemistry","Biology","ComputerScience","Economics","Commerce","Accountancy" };
    String date,tech;
    EditText et1,et2;
    Button button;
    ...
    private void reg(){
        ...
        if(reg.isEmpty())
        {
            ...
            if(remark.isEmpty())
            {
                ...
                StringRequest stringRequest = new StringRequest( Request.Method.POST,Constants.URL_REGISTER9,
